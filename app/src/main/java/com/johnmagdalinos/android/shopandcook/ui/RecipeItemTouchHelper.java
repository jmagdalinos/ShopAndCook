...
/**
 * ItemTouchHelper used to enable swipe deletion of recipes
 */

public class RecipeItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    /** Member variables */
    private RecyclerItemTouchHelperListener mListener;

    /** Creates a Callback for the given drag and swipe allowance. */
    public RecipeItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (viewHolder != null) {
            final View foregroundView = ((RecipeListAdapter.ViewHolder) viewHolder)
                    .mForegroundView;
    ...
    public void onChildDrawOver(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        final View foregroundView = ((RecipeListAdapter.ViewHolder) viewHolder).mForegroundView;
    ...
    public void onChildDraw(Canvas c, RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
        ...
        View backgroundLeft = ((RecipeListAdapter.ViewHolder) viewHolder).mBackgroundViewLeft;
        View backgroundRight = ((RecipeListAdapter.ViewHolder) viewHolder).mBackgroundViewRight;
